...
driver.get(
    "https://www.ozon.ru/category/posuda-dlya-prigotovleniya-19005/?price=79.000%3B1000.000&reviews_count=1.000%3B200.000")
...
while True:
    try:
        for card in driver.find_elements(By.CLASS_NAME, "i3p"):
            ...
            hyper_link = card.find_element(By.CLASS_NAME, "tile-hover-target").text
            ...
            csv_writer.writerow([name, str(price), reviews])
